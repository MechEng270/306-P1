...
int  yIn = yyIn * 42;
  ...
  while ((abs(errorX) > 10) || (abs(errorY) > 10)) {
    ...
    errorDX = errorX - lastErrorX;
    errorDY = errorY - lastErrorY;
    lastErrorX = errorX;
    lastErrorY = errorY;    
    ...
    effortA = (kp * (errorX + errorY)) + (ki * (integralX + integralY)) + (kd * (errorDX + errorDY)) ;
    effortB = (kp * (errorX - errorY)) + (ki * (integralX - integralY)) + (kd * (errorDX - errorDY));
